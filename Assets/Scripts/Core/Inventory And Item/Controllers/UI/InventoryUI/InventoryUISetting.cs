using UnityEngine;
using SDictionary = AYellowpaper.SerializedCollections.SerializedDictionary<int, UnityEngine.Sprite>;

namespace Core.Inventory_And_Item.Controllers.UI.InventoryUI
{
    [CreateAssetMenu(menuName = "CreateOrAdd InventoryUISetting", fileName = "InventoryUISetting", order = 0)]
    public class InventoryUISetting : ScriptableObject
    {
        ...
        public SDictionary slotBackground;
        ...
        public static InventoryUISetting Create(
            ...
            SDictionary slotSelectedSprites    = null)
        {
            ...
            inventoryUISetting.slotBackground         = slotSelectedSprites ?? new SDictionary();
        ...
        public void Deconstruct(
            ...
            out SDictionary slotBackground)
        {
